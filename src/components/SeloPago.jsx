...
export default function SeloPago({ label = 'Pago', className = '' }) {
  return (
    <motion.span
      ...
      className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-md border-2 border-success text-success font-bold text-xs uppercase tracking-wider ${className}`}
